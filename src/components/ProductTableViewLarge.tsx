...
export const ProductTableViewLarge: React.FC<InternalProductTableInterface> = props => {
        ...
        return (
            <Table.Row>
                ...
                <Table.HeaderCell
                    ...
                    sorted={props.sortColumn === 'barcode' ? props.sortDirection : undefined}
                >
                    Barcode
                </Table.HeaderCell>
                <Table.HeaderCell
                ...
                <Table.HeaderCell
                    ...
                    sorted={props.sortColumn === 'purchasePricePerUnit' ? props.sortDirection : undefined}
                >
                    Costs
                </Table.HeaderCell>
                <Table.HeaderCell
                    onClick={props.sortTable('unit')}
                    sorted={props.sortColumn === 'unit' ? props.sortDirection : undefined}
                >
                    Unit
                </Table.HeaderCell>
                <Table.HeaderCell
                    onClick={props.sortTable('createdTime')}
                    sorted={props.sortColumn === 'createdTime' ? props.sortDirection : undefined}
                >
                    Created at
                </Table.HeaderCell>
                <Table.HeaderCell
    ...
    return (
        <Table striped sortable unstackable>
            <Table.Header>{renderHeaderRowLarge()}</Table.Header>
            <Table.Body>{props.products.map(product => renderProductRowLarge(product))}</Table.Body>
        </Table>
    )
}
