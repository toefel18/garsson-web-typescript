    ...
    return (
        ...
        >
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <div>
                    <strong>Order {props.order.orderId}</strong>
                </div>
                <div>
                    <Label>{props.order.state}</Label>
                </div>
            </div>
            <span>Created: {createdTime}</span>
            <br />
            <span>Prepared: {preparedTime}</span>
            <br />
            <span>Delivered: {deliveredTime}</span>
            <br />
            <span>Paid: {paidTime}</span>
            <br />
            <span>Waiter: {props.order.waiterId}</span>
            <br />
            <span>Tafel: {props.order.tableId}</span>
            <br />
